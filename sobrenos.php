...
<nav>
    ...
    <div class="container">
        <div class="display">
            ...
            <p id="info"><span id="text">Nosso Propósito:</span><br>
    ...
    <p id="info2"><span id="text">Como Funcionamos:</span><br>
    ...
    <div class="integrantes">
        ...
        <div class="img-integrantes">
            <div class="teste-img">
                ...
                <p id="descricao-alice">Alice de Lima</p>
                <p id="descricao2">Back-end e Segurança</p>
            </div>
            <div class="teste-img">
                <img id="alice" src="./src/integrantes/foto-lana.jpg">
                <p id="descricao-alice">Lana Araújo</p>
                <p id="descricao-lana">Desing</p>
            </div>
            <div class="teste-img">
                <img id="alice" src="./src/integrantes/foto-rafael.jpg">
                <p id="descricao-alice">Rafael Henrique</p>
                <p id="descricao-rafael">Analista</p>
            </div>
            <div class="teste-img">
                <img id="alice" src="./src/integrantes/foto-vitor.jpg">
                <p id="descricao-alice">Vitor Antonio</p>
                <p id="descricao-vitor">Product owner</p>
            </div>
        </div>
    </div>
    <footer>
